...
class Event(models.Model):
    owner = models.ForeignKey(verbose_name='event_owner', to=CalendarUser, on_delete=models.CASCADE, related_name='event_owner')
    ...
    participants = models.ManyToManyField(verbose_name='event_participants', to=CalendarUser, blank=True, related_name='event_participants')
    location = models.ForeignKey(verbose_name='event_location', to=ConferenceRoom, blank=True, on_delete=models.CASCADE)